...
@Autonomous(name = "RedStone&ParkFoundation", group = "Stone")
public class G9F9RedLoadAutoTestStoneFoundationPark extends G9F9AutonomousHardwareMap{
    ...
    public void runOpMode(){
        ...
        if (state == 6){ //move right across bridge to foundation
        ...
        if (state == 10){ //park, moving to the left, underneath the alliance bridge
            telemetry.addData("State","9");
            telemetry.update();
            strafeLeft(.7,48);
            state = 11;
